...
// @ts-nocheck 
/*
 * This file exports the `PaymentKey` model and its related types.
 *
...
export type GetPaymentKeyAggregateType<T extends PaymentKeyAggregateArgs> = {
      [P in keyof T & keyof AggregatePaymentKey]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePaymentKey[P]>
    : Prisma.GetScalarType<T[P], AggregatePaymentKey[P]>
}
...
export type GetPaymentKeyGroupByPayload<T extends PaymentKeyGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PaymentKeyGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PaymentKeyGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PaymentKeyGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PaymentKeyGroupByOutputType[P]>
      }
    >
  >
...
export type PaymentKeyCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PaymentKeyFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PaymentKeyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PaymentKey'], meta: { name: 'PaymentKey' } }
  /**
   ...
   * })
  **/
  count<T extends PaymentKeyCountArgs>(
    args?: Prisma.Subset<T, PaymentKeyCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PaymentKeyCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PaymentKeyGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PaymentKeyGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPaymentKeyGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
